...
def set_rating_score(driver, form, score="5"):
    ...
    Supports:
    1. select name='score'
    2. radio name='score' value='5'
    3. hidden/input name='score'
    4. name='rating'
    5. name='stars'
    """
    ...
    # Try any input with name score/rating/stars
    for name in possible_names:
        elements = form.find_elements(By.NAME, name)
...
try:
    ...
    # Step 2: Open material detail page
    ...
    # Step 3: Find rating form
    rating_form = find_rating_form(driver)

    # Step 4: Set rating score 5
    set_rating_score(driver, rating_form, "5")

    # Step 5: Fill review if review field exists
    fill_review_if_exists(rating_form)

    # Step 6: Submit rating form
    submit_rating_form(driver, rating_form)

    # Step 7: Wait and verify database
